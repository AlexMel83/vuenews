<template>
  <div class="card mb-3 p-3 my-card">
    <div
      class="container m-0 p-0 d-flex justify-content-between align-items-center mb-3"
    >
      <span class="badge bg-secondary">{{ newsCategory }}</span>
      <span class="time"
        >{{ article.publishedAt.substring(0, 10) }} at
    ...
    <div class="card-body d-flex flex-column">
      <div class="d-flex container flex-column m-0 p-0">
        ...
        <button
          ...
          role="button"
          :data-bs-target="'#t' + myid"
          :aria-controls="'t' + myid"
          aria-expanded="false"
        >
          Read {{ moreless }}
        </button>
      ...
      <p class="card-text">
        <small class="text-body-secondary">
          ...
          ></small
        ><small class="text-body-secondary"
          ><!-- Published: {{ article.publishedAt.substring(0, 10) }}--></small
        >
      </p>
    </div>
  </div>
